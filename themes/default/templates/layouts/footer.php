<?php
// On récupère la constante créée dans le header. Si elle n'existe pas, on l'invente (pour éviter les erreurs)
$hideBecomeVendor = defined('HIDE_BECOME_VENDOR') ? HIDE_BECOME_VENDOR : false;
?>
<footer class="mango-footer" style="background: #090d16; color: #94a3b8; padding: 60px 20px 30px; border-top: 1px solid #1e293b; margin-top: auto;">
    <div class="container" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 40px; margin-bottom: 40px; max-width: 1280px; margin-left: auto; margin-right: auto;">
        ...
        <div>
            ...
            <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 10px; font-size: 14px;">
                ...
                <!-- MASQUÉ SI L'UTILISATEUR EST DÉJÀ VENDEUR OU ADMIN -->
